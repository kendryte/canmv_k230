# ============================================================
# MicroPython 图像高斯滤波测试代码（cv_lite 扩展模块）
# RGB888 Gaussian Blur Filter Test using cv_lite extension
# ============================================================
...
import _thread
import cv_lite               # cv_lite扩展模块 / cv_lite extension (includes gaussian_blur API)
