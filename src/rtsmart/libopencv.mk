opencv_lib_dir := 
opencv_lib_dir += $(SDK_RTSMART_SRC_DIR)/lib/opencv/lib
opencv_lib_dir += $(SDK_RTSMART_SRC_DIR)/lib/opencv/lib/opencv4/3rdparty

opencv_libs := $(addprefix -l,$(subst lib, ,$(basename $(notdir $(foreach dir, $(opencv_lib_dir), $(wildcard $(dir)/*))))))

OPENCV_INC = -I$(SDK_RTSMART_SRC_DIR)/lib/opencv/include/opencv4
